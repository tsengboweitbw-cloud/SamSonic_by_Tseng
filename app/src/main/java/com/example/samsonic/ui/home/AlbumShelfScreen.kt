 ...
 * [homeAlbums] is Home's own row for a [HomeShelf.sharesHomeList] shelf, shown as
 * is; otherwise the page loads the shelf's longer list itself. For an album shelf.
 */
@Composable
